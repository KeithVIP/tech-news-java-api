...
@Controller
/*
The HomePageController serves as more of a navigator—essentially, it is the entry and exit point for users. This controller is composed of @GetMapping annotation endpoints that help direct the flow of the API.
*/
